...
export ASUS_DOCKER_ENV_IMAGE="asus-iot/asus-docker-env-p-rk3399pro:latest"
export ASUS_DOCKER_ENV_WORKDIR=${ASUS_DOCKER_ENV_DEFAULT_WORKDIR}
export ASUS_DOCKER_EVN_OPTIONS="--interactive --privileged --rm --tty --hostname asus-docker-env-p-rk3399pro --volume $ASUS_DOCKER_ENV_SOURCE:$ASUS_DOCKER_ENV_WORKDIR --workdir $ASUS_DOCKER_ENV_WORKDIR"
